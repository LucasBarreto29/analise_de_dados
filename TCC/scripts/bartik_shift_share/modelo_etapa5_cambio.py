...
print("=== INICIANDO ETAPA 5: INTEGRAÇÃO DO CÂMBIO (BRL/USD) ===")
...
# O Câmbio é uma variável puramente temporal, então sua diferença é igual para todos os setores
...
# Dropna final
colunas_necessarias = [
    'd_ln_Produtividade', 'd_ln_Bartik_Tech', 'd_ln_Bartik_Tech_lag1',
    'Stringency_Index', 'd_ln_Cambio'
]
df_final = df.dropna(subset=colunas_necessarias).copy()
df_final['const'] = 1

# 3. Estimação do Modelo Definitivo com Câmbio
print("3. Estimando o Modelo Definitivo (1 Lag + Driscoll-Kraay + Câmbio)...")
exog_vars = ['const', 'd_ln_Bartik_Tech', 'd_ln_Bartik_Tech_lag1', 'Stringency_Index', 'd_ln_Cambio']
...
print("\n================================================================================")
print("     RESULTADO DO MODELO DEFINITIVO - DRISCOLL-KRAAY / 1 LAG + CÂMBIO           ")
print("================================================================================")
...
print("================================================================================")
print("Hipótese Nula (H0): O efeito acumulado num semestre é zero.")
