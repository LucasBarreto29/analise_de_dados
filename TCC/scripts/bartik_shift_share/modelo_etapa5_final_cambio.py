...
print("=== INICIANDO ETAPA 5 (REVISADA FINAL): CÂMBIO E REMOÇÃO DO OXFORD ===")
...
# Dropna final SEM O STRINGENCY_INDEX
colunas_necessarias = [
...
# 3. Estimação do Modelo Definitivo com Câmbio e sem Oxford
print("3. Estimando o Modelo Definitivo (1 Lag + Driscoll-Kraay + Câmbio - Oxford)...")
exog_vars = ['const', 'd_ln_Bartik_Tech', 'd_ln_Bartik_Tech_lag1', 'VAB_Industria_Volume', 'd_ln_Cambio']
...
print("\n================================================================================")
print("  RESULTADO DO MODELO FINAL - DRISCOLL-KRAAY (Com Câmbio e sem Oxford)          ")
print("================================================================================")
